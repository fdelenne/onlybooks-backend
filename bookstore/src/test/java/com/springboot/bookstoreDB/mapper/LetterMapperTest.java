...
public class LetterMapperTest
{
    ...
    {
        assertEquals(null, letterMapper.modelToDto(null, true));
    }

    @Test
    public void dtoToModelNullTest()
    {
        assertEquals(null, letterMapper.dtoToModel(null));
    }

    @Test
    public void commentEntityToCommentDTONullTest()
    {
        assertEquals(null, letterMapper.commentEntityToCommentDTO(null));
    }
    ...
    public void commentEntityToCommentDTOTest()
    {
        ...
        CommentDTO commentDTO = letterMapper.commentEntityToCommentDTO(commentEntity);
    ...
    {
        assertEquals(null, letterMapper.commentDTOToCommentEntity(null));
    }
    ...
    public void commentDTOToCommentEntityTest()
    {
        ...
        CommentEntity commentEntity = letterMapper.commentDTOToCommentEntity(commentDTO);
    ...
    {
        assertEquals(null, letterMapper.commentDTOListToCommentEntityList(null));
    }
    ...
    public void commentDTOListToCommentEntityListTest()
    {
        ...
        List<CommentEntity> commentEntityList = letterMapper.commentDTOListToCommentEntityList(commentDTOList);
    ...
    {
        assertEquals(null, letterMapper.commentEntityListToCommentDTOList(null));
    }
    ...
    public void commentEntityListToCommentDTOListTest()
    {
        ...
        List<CommentDTO> commentDTOList = letterMapper.commentEntityListToCommentDTOList(commentEntityList);
