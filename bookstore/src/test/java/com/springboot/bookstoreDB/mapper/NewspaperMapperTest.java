...
@SpringBootTest
public class NewspaperMapperTest
{
    @Autowired
    ...
    {
        assertEquals(null, newspaperMapper.modelToDto(null, true));
    }

    @Test
    public void dtoToModelNullTest()
    {
        assertEquals(null, newspaperMapper.dtoToModel(null));
    }

    @Test
    public void commentEntityToCommentDTONullTest()
    {
        assertEquals(null, newspaperMapper.commentEntityToCommentDTO(null));
    }
    ...
    public void commentEntityToCommentDTOTest()
    {
        ...
        CommentDTO commentDTO = newspaperMapper.commentEntityToCommentDTO(commentEntity);
    ...
    {
        assertEquals(null, newspaperMapper.commentDTOToCommentEntity(null));
    }
    ...
    public void commentDTOToCommentEntityTest()
    {
        ...
        CommentEntity commentEntity = newspaperMapper.commentDTOToCommentEntity(commentDTO);
    ...
    {
        assertEquals(null, newspaperMapper.commentDTOListToCommentEntityList(null));
    }
    ...
    public void commentDTOListToCommentEntityListTest()
    {
        ...
        List<CommentEntity> commentEntityList = newspaperMapper.commentDTOListToCommentEntityList(commentDTOList);
    ...
    {
        assertEquals(null, newspaperMapper.commentEntityListToCommentDTOList(null));
    }
    ...
    public void commentEntityListToCommentDTOListTest()
    {
        ...
        List<CommentDTO> commentDTOList = newspaperMapper.commentEntityListToCommentDTOList(commentEntityList);
